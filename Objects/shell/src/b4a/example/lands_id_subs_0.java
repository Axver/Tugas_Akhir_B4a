...
public class lands_id_subs_0 {


public static RemoteObject  _activity_create(RemoteObject _firsttime) throws Exception{
try {
		Debug.PushSubsStack("Activity_Create (lands_id) ","lands_id",18,lands_id.mostCurrent.activityBA,lands_id.mostCurrent,25);
if (RapidSub.canDelegate("activity_create")) { return b4a.example.lands_id.remoteMe.runUserSub(false, "lands_id","activity_create", _firsttime);}
Debug.locals.put("FirstTime", _firsttime);
 BA.debugLineNum = 25;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 27;BA.debugLine="Activity.LoadLayout(\"lands_id\")";
Debug.ShouldStop(67108864);
lands_id.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("lands_id")),lands_id.mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="WebView1.LoadUrl(domain&\"ta_v2/endpoint/view/laye";
Debug.ShouldStop(268435456);
lands_id.mostCurrent._webview1.runVoidMethod ("LoadUrl",(Object)(RemoteObject.concat(lands_id.mostCurrent._domain,RemoteObject.createImmutable("ta_v2/endpoint/view/layers.php?request=all"))));
 BA.debugLineNum = 30;BA.debugLine="ProgressDialogShow(\"Loading...\")";
Debug.ShouldStop(536870912);
lands_id.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",lands_id.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Loading..."))));
...
try {
		Debug.PushSubsStack("Activity_Pause (lands_id) ","lands_id",18,lands_id.mostCurrent.activityBA,lands_id.mostCurrent,39);
if (RapidSub.canDelegate("activity_pause")) { return b4a.example.lands_id.remoteMe.runUserSub(false, "lands_id","activity_pause", _userclosed);}
...
try {
		Debug.PushSubsStack("Activity_Resume (lands_id) ","lands_id",18,lands_id.mostCurrent.activityBA,lands_id.mostCurrent,35);
if (RapidSub.canDelegate("activity_resume")) { return b4a.example.lands_id.remoteMe.runUserSub(false, "lands_id","activity_resume");}
...
try {
		Debug.PushSubsStack("Button1_Click (lands_id) ","lands_id",18,lands_id.mostCurrent.activityBA,lands_id.mostCurrent,49);
if (RapidSub.canDelegate("button1_click")) { return b4a.example.lands_id.remoteMe.runUserSub(false, "lands_id","button1_click");}
RemoteObject _land_id = RemoteObject.createImmutable("");
 BA.debugLineNum = 49;BA.debugLine="Sub Button1_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 50;BA.debugLine="Dim land_id As String";
Debug.ShouldStop(131072);
_land_id = RemoteObject.createImmutable("");Debug.locals.put("land_id", _land_id);
 BA.debugLineNum = 51;BA.debugLine="land_id= EditText1.Text";
Debug.ShouldStop(262144);
_land_id = lands_id.mostCurrent._edittext1.runMethod(true,"getText");Debug.locals.put("land_id", _land_id);
...
lands_id.mostCurrent._job2.runVoidMethod ("_initialize",lands_id.processBA,(Object)(BA.ObjectToString("Job2")),(Object)(lands_id.getObject()));
 BA.debugLineNum = 57;BA.debugLine="job2.PostString(domain&\"ta_v2/endpoint/land.php\",";
Debug.ShouldStop(16777216);
lands_id.mostCurrent._job2.runVoidMethod ("_poststring",(Object)(RemoteObject.concat(lands_id.mostCurrent._domain,RemoteObject.createImmutable("ta_v2/endpoint/land.php"))),(Object)(RemoteObject.concat(RemoteObject.createImmutable("land_id="),_land_id)));
 BA.debugLineNum = 58;BA.debugLine="WebView1.LoadUrl(domain&\"ta_v2/endpoint/view/land";
Debug.ShouldStop(33554432);
lands_id.mostCurrent._webview1.runVoidMethod ("LoadUrl",(Object)(RemoteObject.concat(lands_id.mostCurrent._domain,RemoteObject.createImmutable("ta_v2/endpoint/view/land_id.php?land_id="),_land_id)));
...
lands_id.mostCurrent._webview1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.WebViewWrapper");
 //BA.debugLineNum = 17;BA.debugLine="Dim domain As String";
lands_id.mostCurrent._domain = RemoteObject.createImmutable("");
 //BA.debugLineNum = 18;BA.debugLine="Dim job2 As HttpJob";
lands_id.mostCurrent._job2 = RemoteObject.createNew ("anywheresoftware.b4a.samples.httputils2.httpjob");
 //BA.debugLineNum = 20;BA.debugLine="domain=\"http://ca024f23.ngrok.io/\"";
lands_id.mostCurrent._domain = BA.ObjectToString("http://ca024f23.ngrok.io/");
 //BA.debugLineNum = 21;BA.debugLine="Private EditText1 As EditText";
lands_id.mostCurrent._edittext1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.EditTextWrapper");
 //BA.debugLineNum = 22;BA.debugLine="Private ListView1 As ListView";
lands_id.mostCurrent._listview1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.ListViewWrapper");
 //BA.debugLineNum = 23;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _jobdone(RemoteObject _job) throws Exception{
try {
		Debug.PushSubsStack("JobDone (lands_id) ","lands_id",18,lands_id.mostCurrent.activityBA,lands_id.mostCurrent,62);
if (RapidSub.canDelegate("jobdone")) { return b4a.example.lands_id.remoteMe.runUserSub(false, "lands_id","jobdone", _job);}
...
lands_id.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname"),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success"))));
 BA.debugLineNum = 65;BA.debugLine="If Job.Success = True Then";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",_job.getField(true,"_success"),lands_id.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 66;BA.debugLine="ProgressDialogHide";
Debug.ShouldStop(2);
lands_id.mostCurrent.__c.runVoidMethod ("ProgressDialogHide");
...
_parser.runVoidMethod ("Initialize",(Object)(_job.runMethod(true,"_getstring")));
 BA.debugLineNum = 71;BA.debugLine="Log(Job.GetString)";
Debug.ShouldStop(64);
lands_id.mostCurrent.__c.runVoidMethod ("Log",(Object)(_job.runMethod(true,"_getstring")));
...
Debug.locals.put("colfeatures", _colfeatures);
 BA.debugLineNum = 75;BA.debugLine="Dim geometry As Map = colfeatures.Get(\"geomet";
...
_geometry.setObject(_colfeatures.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("geometry")))));Debug.locals.put("geometry", _geometry);
 BA.debugLineNum = 76;BA.debugLine="Dim coordinates As List = geometry.Get(\"coord";
...
_coordinates.setObject(_geometry.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("coordinates")))));Debug.locals.put("coordinates", _coordinates);
 BA.debugLineNum = 77;BA.debugLine="For Each colcoordinates As List In coordinate";
...
Debug.locals.put("colcoordinates", _colcoordinates);
 BA.debugLineNum = 78;BA.debugLine="For Each colcolcoordinates As List In colcoo";
...
Debug.locals.put("colcolcoordinates", _colcolcoordinates);
 BA.debugLineNum = 79;BA.debugLine="For Each colcolcolcoordinates As List In co";
...
Debug.locals.put("colcolcolcoordinates", _colcolcolcoordinates);
 BA.debugLineNum = 80;BA.debugLine="For Each colcolcolcolcoordinates As Double";
...
;
 BA.debugLineNum = 85;BA.debugLine="Dim Type As String = geometry.Get(\"type\")";
...
_type = BA.ObjectToString(_geometry.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("type")))));Debug.locals.put("Type", _type);Debug.locals.put("Type", _type);
 BA.debugLineNum = 86;BA.debugLine="Dim Type As String = colfeatures.Get(\"type\")";
Debug.ShouldStop(2097152);
...
_properties.setObject(_colfeatures.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("properties")))));Debug.locals.put("properties", _properties);
 BA.debugLineNum = 88;BA.debugLine="Dim clan_name As String = properties.Get(\"cla";
Debug.ShouldStop(8388608);
_clan_name = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("clan_name")))));Debug.locals.put("clan_name", _clan_name);Debug.locals.put("clan_name", _clan_name);
 BA.debugLineNum = 89;BA.debugLine="Dim owner_name As String = properties.Get(\"ow";
Debug.ShouldStop(16777216);
_owner_name = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("owner_name")))));Debug.locals.put("owner_name", _owner_name);Debug.locals.put("owner_name", _owner_name);
 BA.debugLineNum = 90;BA.debugLine="Dim gender As String = properties.Get(\"gender";
Debug.ShouldStop(33554432);
_gender = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("gender")))));Debug.locals.put("gender", _gender);Debug.locals.put("gender", _gender);
 BA.debugLineNum = 91;BA.debugLine="Dim land_owner As String = properties.Get(\"la";
Debug.ShouldStop(67108864);
_land_owner = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("land_owner")))));Debug.locals.put("land_owner", _land_owner);Debug.locals.put("land_owner", _land_owner);
 BA.debugLineNum = 92;BA.debugLine="Dim phone As String = properties.Get(\"phone\")";
Debug.ShouldStop(134217728);
_phone = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("phone")))));Debug.locals.put("phone", _phone);Debug.locals.put("phone", _phone);
 BA.debugLineNum = 93;BA.debugLine="Dim tax_number As String = properties.Get(\"ta";
Debug.ShouldStop(268435456);
_tax_number = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("tax_number")))));Debug.locals.put("tax_number", _tax_number);Debug.locals.put("tax_number", _tax_number);
 BA.debugLineNum = 94;BA.debugLine="Dim status_name As String = properties.Get(\"s";
Debug.ShouldStop(536870912);
_status_name = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("status_name")))));Debug.locals.put("status_name", _status_name);Debug.locals.put("status_name", _status_name);
 BA.debugLineNum = 95;BA.debugLine="Dim x As String = properties.Get(\"x\")";
...
_x = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("x")))));Debug.locals.put("x", _x);Debug.locals.put("x", _x);
 BA.debugLineNum = 96;BA.debugLine="Dim y As String = properties.Get(\"y\")";
Debug.ShouldStop(-2147483648);
_y = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("y")))));Debug.locals.put("y", _y);Debug.locals.put("y", _y);
 BA.debugLineNum = 97;BA.debugLine="Dim land_id As String = properties.Get(\"land_";
Debug.ShouldStop(1);
...
_born_date = BA.ObjectToString(_properties.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("born_date")))));Debug.locals.put("born_date", _born_date);Debug.locals.put("born_date", _born_date);
 BA.debugLineNum = 100;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize = 1";
Debug.ShouldStop(8);
lands_id.mostCurrent._listview1.runMethod(false,"getSingleLineLayout").getField(false,"Label").runMethod(true,"setTextSize",BA.numberCast(float.class, 12));
 BA.debugLineNum = 101;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor =";
Debug.ShouldStop(16);
lands_id.mostCurrent._listview1.runMethod(false,"getSingleLineLayout").getField(false,"Label").runMethod(true,"setTextColor",lands_id.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 102;BA.debugLine="ListView1.AddSingleLine(\"History\")";
Debug.ShouldStop(32);
lands_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("History"))));
 BA.debugLineNum = 103;BA.debugLine="ListView1.AddSingleLine(\"Clan Name:\"&clan_nam";
Debug.ShouldStop(64);
lands_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Clan Name:"),_clan_name))));
 BA.debugLineNum = 104;BA.debugLine="ListView1.AddSingleLine(\"Owner Name:\"&owner_n";
Debug.ShouldStop(128);
lands_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Owner Name:"),_owner_name))));
 BA.debugLineNum = 105;BA.debugLine="ListView1.AddSingleLine(\"Gender:\"&gender)";
Debug.ShouldStop(256);
lands_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Gender:"),_gender))));
 }
}Debug.locals.put("colfeatures", _colfeatures);
;
 BA.debugLineNum = 107;BA.debugLine="Dim Type As String = root.Get(\"type\")";
Debug.ShouldStop(1024);
...
Debug.ShouldStop(4194304);
lands_id.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage"))));
 BA.debugLineNum = 120;BA.debugLine="ToastMessageShow(\"Error: \" & Job.ErrorMessage, T";
Debug.ShouldStop(8388608);
lands_id.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage")))),(Object)(lands_id.mostCurrent.__c.getField(true,"True")));
 };
...
try {
		Debug.PushSubsStack("webview1_PageFinished (lands_id) ","lands_id",18,lands_id.mostCurrent.activityBA,lands_id.mostCurrent,43);
if (RapidSub.canDelegate("webview1_pagefinished")) { return b4a.example.lands_id.remoteMe.runUserSub(false, "lands_id","webview1_pagefinished", _strurl);}
