...
Debug.ShouldStop(16777216);
 BA.debugLineNum = 27;BA.debugLine="Activity.LoadLayout(\"buildings\")";
Debug.ShouldStop(67108864);
buildings.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("buildings")),buildings.mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="WebView1.LoadUrl(domain&\"ta_v2/endpoint/view/laye";
Debug.ShouldStop(268435456);
buildings.mostCurrent._webview1.runVoidMethod ("LoadUrl",(Object)(RemoteObject.concat(buildings.mostCurrent._domain,RemoteObject.createImmutable("ta_v2/endpoint/view/layers.php?request=all"))));
 BA.debugLineNum = 30;BA.debugLine="ProgressDialogShow(\"Loading...\")";
Debug.ShouldStop(536870912);
buildings.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",buildings.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Loading..."))));
...
_tax_number = buildings.mostCurrent._edittext1.runMethod(true,"getText");Debug.locals.put("tax_number", _tax_number);
 BA.debugLineNum = 53;BA.debugLine="WebView1.LoadUrl(domain&\"ta_v2/endpoint/view/land";
Debug.ShouldStop(1048576);
buildings.mostCurrent._webview1.runVoidMethod ("LoadUrl",(Object)(RemoteObject.concat(buildings.mostCurrent._domain,RemoteObject.createImmutable("ta_v2/endpoint/view/land_tax_view.php?tax_number="),_tax_number)));
...
buildings.mostCurrent._job2.runVoidMethod ("_initialize",buildings.processBA,(Object)(BA.ObjectToString("Job2")),(Object)(buildings.getObject()));
 BA.debugLineNum = 57;BA.debugLine="job2.PostString(domain&\"ta_v2/endpoint/land_tax.p";
Debug.ShouldStop(16777216);
buildings.mostCurrent._job2.runVoidMethod ("_poststring",(Object)(RemoteObject.concat(buildings.mostCurrent._domain,RemoteObject.createImmutable("ta_v2/endpoint/land_tax.php"))),(Object)(RemoteObject.concat(RemoteObject.createImmutable("tax_number="),_tax_number)));
...
buildings.mostCurrent._webview1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.WebViewWrapper");
 //BA.debugLineNum = 17;BA.debugLine="Dim domain As String";
buildings.mostCurrent._domain = RemoteObject.createImmutable("");
 //BA.debugLineNum = 18;BA.debugLine="Dim job2 As HttpJob";
buildings.mostCurrent._job2 = RemoteObject.createNew ("anywheresoftware.b4a.samples.httputils2.httpjob");
 //BA.debugLineNum = 20;BA.debugLine="domain=\"http://34d0b8ce.ngrok.io/\"";
buildings.mostCurrent._domain = BA.ObjectToString("http://34d0b8ce.ngrok.io/");
 //BA.debugLineNum = 21;BA.debugLine="Private EditText1 As EditText";
buildings.mostCurrent._edittext1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.EditTextWrapper");
 //BA.debugLineNum = 22;BA.debugLine="Private ListView1 As ListView";
buildings.mostCurrent._listview1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.ListViewWrapper");
...
buildings.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname"),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success"))));
 BA.debugLineNum = 64;BA.debugLine="If Job.Success = True Then";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("=",_job.getField(true,"_success"),buildings.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 65;BA.debugLine="ProgressDialogHide";
Debug.ShouldStop(1);
buildings.mostCurrent.__c.runVoidMethod ("ProgressDialogHide");
...
Debug.ShouldStop(32);
buildings.mostCurrent.__c.runVoidMethod ("Log",(Object)(_job.runMethod(true,"_getstring")));
...
Debug.ShouldStop(8);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Information"))));
 BA.debugLineNum = 101;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize = 1";
Debug.ShouldStop(16);
buildings.mostCurrent._listview1.runMethod(false,"getSingleLineLayout").getField(false,"Label").runMethod(true,"setTextSize",BA.numberCast(float.class, 12));
 BA.debugLineNum = 102;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor =";
Debug.ShouldStop(32);
buildings.mostCurrent._listview1.runMethod(false,"getSingleLineLayout").getField(false,"Label").runMethod(true,"setTextColor",buildings.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 103;BA.debugLine="ListView1.AddSingleLine(\"Clan Name:\"&clan_nam";
Debug.ShouldStop(64);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Clan Name:"),_clan_name))));
 BA.debugLineNum = 104;BA.debugLine="ListView1.AddSingleLine(\"Owner Name:\"&owner_n";
Debug.ShouldStop(128);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Owner Name:"),_owner_name))));
 BA.debugLineNum = 105;BA.debugLine="ListView1.AddSingleLine(\"Gender:\"&gender)";
Debug.ShouldStop(256);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Gender:"),_gender))));
 BA.debugLineNum = 106;BA.debugLine="ListView1.AddSingleLine(\"Land Owner:\"&land_ow";
Debug.ShouldStop(512);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Land Owner:"),_land_owner))));
 BA.debugLineNum = 107;BA.debugLine="ListView1.AddSingleLine(\"Phone:\"&phone)";
Debug.ShouldStop(1024);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Phone:"),_phone))));
 BA.debugLineNum = 108;BA.debugLine="ListView1.AddSingleLine(\"Tax Number:\"&tax_num";
Debug.ShouldStop(2048);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Tax Number:"),_tax_number))));
 BA.debugLineNum = 109;BA.debugLine="ListView1.AddSingleLine(\"Status:\"&status_name";
Debug.ShouldStop(4096);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Status:"),_status_name))));
 BA.debugLineNum = 110;BA.debugLine="ListView1.AddSingleLine(\"Land Id:\"&land_id)";
Debug.ShouldStop(8192);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Land Id:"),_land_id))));
 BA.debugLineNum = 111;BA.debugLine="ListView1.AddSingleLine(\"Coordinates:\"&x&\"||\"";
Debug.ShouldStop(16384);
buildings.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Coordinates:"),_x,RemoteObject.createImmutable("||"),_y))));
 }
}Debug.locals.put("colfeatures", _colfeatures);
;
...
Debug.ShouldStop(268435456);
buildings.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage"))));
 BA.debugLineNum = 126;BA.debugLine="ToastMessageShow(\"Error: \" & Job.ErrorMessage, T";
Debug.ShouldStop(536870912);
buildings.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage")))),(Object)(buildings.mostCurrent.__c.getField(true,"True")));
 };
