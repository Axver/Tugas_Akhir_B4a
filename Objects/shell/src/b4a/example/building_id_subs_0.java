...
public class building_id_subs_0 {


public static RemoteObject  _activity_create(RemoteObject _firsttime) throws Exception{
try {
		Debug.PushSubsStack("Activity_Create (building_id) ","building_id",12,building_id.mostCurrent.activityBA,building_id.mostCurrent,25);
if (RapidSub.canDelegate("activity_create")) { return b4a.example.building_id.remoteMe.runUserSub(false, "building_id","activity_create", _firsttime);}
Debug.locals.put("FirstTime", _firsttime);
 BA.debugLineNum = 25;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 27;BA.debugLine="Activity.LoadLayout(\"building_id\")";
Debug.ShouldStop(67108864);
building_id.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("building_id")),building_id.mostCurrent.activityBA);
 BA.debugLineNum = 29;BA.debugLine="WebView1.LoadUrl(domain&\"ta_v2/endpoint/view/laye";
Debug.ShouldStop(268435456);
building_id.mostCurrent._webview1.runVoidMethod ("LoadUrl",(Object)(RemoteObject.concat(building_id.mostCurrent._domain,RemoteObject.createImmutable("ta_v2/endpoint/view/layers.php?request=all"))));
 BA.debugLineNum = 30;BA.debugLine="ProgressDialogShow(\"Loading...\")";
Debug.ShouldStop(536870912);
building_id.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",building_id.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Loading..."))));
...
try {
		Debug.PushSubsStack("Activity_Pause (building_id) ","building_id",12,building_id.mostCurrent.activityBA,building_id.mostCurrent,39);
if (RapidSub.canDelegate("activity_pause")) { return b4a.example.building_id.remoteMe.runUserSub(false, "building_id","activity_pause", _userclosed);}
...
try {
		Debug.PushSubsStack("Activity_Resume (building_id) ","building_id",12,building_id.mostCurrent.activityBA,building_id.mostCurrent,35);
if (RapidSub.canDelegate("activity_resume")) { return b4a.example.building_id.remoteMe.runUserSub(false, "building_id","activity_resume");}
...
try {
		Debug.PushSubsStack("Button1_Click (building_id) ","building_id",12,building_id.mostCurrent.activityBA,building_id.mostCurrent,49);
if (RapidSub.canDelegate("button1_click")) { return b4a.example.building_id.remoteMe.runUserSub(false, "building_id","button1_click");}
...
_tax_number = building_id.mostCurrent._edittext1.runMethod(true,"getText");Debug.locals.put("tax_number", _tax_number);
 BA.debugLineNum = 53;BA.debugLine="WebView1.LoadUrl(domain&\"ta_v2/endpoint/view/land";
Debug.ShouldStop(1048576);
building_id.mostCurrent._webview1.runVoidMethod ("LoadUrl",(Object)(RemoteObject.concat(building_id.mostCurrent._domain,RemoteObject.createImmutable("ta_v2/endpoint/view/land_tax_view.php?tax_number="),_tax_number)));
...
building_id.mostCurrent._job2.runVoidMethod ("_initialize",building_id.processBA,(Object)(BA.ObjectToString("Job2")),(Object)(building_id.getObject()));
 BA.debugLineNum = 57;BA.debugLine="job2.PostString(domain&\"ta_v2/endpoint/land_tax.p";
Debug.ShouldStop(16777216);
building_id.mostCurrent._job2.runVoidMethod ("_poststring",(Object)(RemoteObject.concat(building_id.mostCurrent._domain,RemoteObject.createImmutable("ta_v2/endpoint/land_tax.php"))),(Object)(RemoteObject.concat(RemoteObject.createImmutable("tax_number="),_tax_number)));
...
building_id.mostCurrent._webview1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.WebViewWrapper");
 //BA.debugLineNum = 17;BA.debugLine="Dim domain As String";
building_id.mostCurrent._domain = RemoteObject.createImmutable("");
 //BA.debugLineNum = 18;BA.debugLine="Dim job2 As HttpJob";
building_id.mostCurrent._job2 = RemoteObject.createNew ("anywheresoftware.b4a.samples.httputils2.httpjob");
 //BA.debugLineNum = 20;BA.debugLine="domain=\"http://34d0b8ce.ngrok.io/\"";
building_id.mostCurrent._domain = BA.ObjectToString("http://34d0b8ce.ngrok.io/");
 //BA.debugLineNum = 21;BA.debugLine="Private EditText1 As EditText";
building_id.mostCurrent._edittext1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.EditTextWrapper");
 //BA.debugLineNum = 22;BA.debugLine="Private ListView1 As ListView";
building_id.mostCurrent._listview1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.ListViewWrapper");
 //BA.debugLineNum = 23;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _jobdone(RemoteObject _job) throws Exception{
try {
		Debug.PushSubsStack("JobDone (building_id) ","building_id",12,building_id.mostCurrent.activityBA,building_id.mostCurrent,61);
if (RapidSub.canDelegate("jobdone")) { return b4a.example.building_id.remoteMe.runUserSub(false, "building_id","jobdone", _job);}
...
building_id.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname"),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success"))));
 BA.debugLineNum = 64;BA.debugLine="If Job.Success = True Then";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("=",_job.getField(true,"_success"),building_id.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 65;BA.debugLine="ProgressDialogHide";
Debug.ShouldStop(1);
building_id.mostCurrent.__c.runVoidMethod ("ProgressDialogHide");
...
Debug.ShouldStop(32);
building_id.mostCurrent.__c.runVoidMethod ("Log",(Object)(_job.runMethod(true,"_getstring")));
...
Debug.ShouldStop(8);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Information"))));
 BA.debugLineNum = 101;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize = 1";
Debug.ShouldStop(16);
building_id.mostCurrent._listview1.runMethod(false,"getSingleLineLayout").getField(false,"Label").runMethod(true,"setTextSize",BA.numberCast(float.class, 12));
 BA.debugLineNum = 102;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor =";
Debug.ShouldStop(32);
building_id.mostCurrent._listview1.runMethod(false,"getSingleLineLayout").getField(false,"Label").runMethod(true,"setTextColor",building_id.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 103;BA.debugLine="ListView1.AddSingleLine(\"Clan Name:\"&clan_nam";
Debug.ShouldStop(64);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Clan Name:"),_clan_name))));
 BA.debugLineNum = 104;BA.debugLine="ListView1.AddSingleLine(\"Owner Name:\"&owner_n";
Debug.ShouldStop(128);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Owner Name:"),_owner_name))));
 BA.debugLineNum = 105;BA.debugLine="ListView1.AddSingleLine(\"Gender:\"&gender)";
Debug.ShouldStop(256);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Gender:"),_gender))));
 BA.debugLineNum = 106;BA.debugLine="ListView1.AddSingleLine(\"Land Owner:\"&land_ow";
Debug.ShouldStop(512);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Land Owner:"),_land_owner))));
 BA.debugLineNum = 107;BA.debugLine="ListView1.AddSingleLine(\"Phone:\"&phone)";
Debug.ShouldStop(1024);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Phone:"),_phone))));
 BA.debugLineNum = 108;BA.debugLine="ListView1.AddSingleLine(\"Tax Number:\"&tax_num";
Debug.ShouldStop(2048);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Tax Number:"),_tax_number))));
 BA.debugLineNum = 109;BA.debugLine="ListView1.AddSingleLine(\"Status:\"&status_name";
Debug.ShouldStop(4096);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Status:"),_status_name))));
 BA.debugLineNum = 110;BA.debugLine="ListView1.AddSingleLine(\"Land Id:\"&land_id)";
Debug.ShouldStop(8192);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Land Id:"),_land_id))));
 BA.debugLineNum = 111;BA.debugLine="ListView1.AddSingleLine(\"Coordinates:\"&x&\"||\"";
Debug.ShouldStop(16384);
building_id.mostCurrent._listview1.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Coordinates:"),_x,RemoteObject.createImmutable("||"),_y))));
 }
}Debug.locals.put("colfeatures", _colfeatures);
;
...
Debug.ShouldStop(268435456);
building_id.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage"))));
 BA.debugLineNum = 126;BA.debugLine="ToastMessageShow(\"Error: \" & Job.ErrorMessage, T";
Debug.ShouldStop(536870912);
building_id.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage")))),(Object)(building_id.mostCurrent.__c.getField(true,"True")));
 };
...
try {
		Debug.PushSubsStack("webview1_PageFinished (building_id) ","building_id",12,building_id.mostCurrent.activityBA,building_id.mostCurrent,43);
if (RapidSub.canDelegate("webview1_pagefinished")) { return b4a.example.building_id.remoteMe.runUserSub(false, "building_id","webview1_pagefinished", _strurl);}
