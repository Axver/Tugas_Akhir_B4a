...
public class add_birth implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("add_birth"), "b4a.example.add_birth");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, add_birth.class);
...
public static b4a.example.owners _owners = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",add_birth.mostCurrent._activity,"add_mortality",Debug.moduleToString(b4a.example.add_mortality.class),"add_outcome",Debug.moduleToString(b4a.example.add_outcome.class),"birth",Debug.moduleToString(b4a.example.birth.class),"building_id",Debug.moduleToString(b4a.example.building_id.class),"building_owner",Debug.moduleToString(b4a.example.building_owner.class),"buildings",Debug.moduleToString(b4a.example.buildings.class),"Button1",add_birth.mostCurrent._button1,"citizen",Debug.moduleToString(b4a.example.citizen.class),"dashboard",Debug.moduleToString(b4a.example.dashboard.class),"domain",add_birth.mostCurrent._domain,"EditText1",add_birth.mostCurrent._edittext1,"EditText2",add_birth.mostCurrent._edittext2,"EditText3",add_birth.mostCurrent._edittext3,"EditText4",add_birth.mostCurrent._edittext4,"EditText5",add_birth.mostCurrent._edittext5,"family_card",Debug.moduleToString(b4a.example.family_card.class),"HttpUtils2Service",add_birth.mostCurrent._httputils2service,"job2",add_birth.mostCurrent._job2,"land_by_owner",Debug.moduleToString(b4a.example.land_by_owner.class),"lands",Debug.moduleToString(b4a.example.lands.class),"lands_id",Debug.moduleToString(b4a.example.lands_id.class),"Main",Debug.moduleToString(b4a.example.main.class),"mortality",Debug.moduleToString(b4a.example.mortality.class),"outcome",Debug.moduleToString(b4a.example.outcome.class),"owner_states",Debug.moduleToString(b4a.example.owner_states.class),"owners",Debug.moduleToString(b4a.example.owners.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}