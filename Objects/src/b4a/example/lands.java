...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 25;BA.debugLine="Activity.LoadLayout(\"lands\")";
mostCurrent._activity.LoadLayout("lands",mostCurrent.activityBA);
 //BA.debugLineNum = 27;BA.debugLine="WebView1.LoadUrl(domain&\"ta_v2/endpoint/view/laye";
...
mostCurrent._job2 = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 20;BA.debugLine="domain=\"http://0b7cfaa1.ngrok.io/\"";
mostCurrent._domain = "http://0b7cfaa1.ngrok.io/";
 //BA.debugLineNum = 21;BA.debugLine="End Sub";
return "";
}
public static String  _pagefinished(String _url) throws Exception{
 //BA.debugLineNum = 40;BA.debugLine="Sub PageFinished (Url As String)";
