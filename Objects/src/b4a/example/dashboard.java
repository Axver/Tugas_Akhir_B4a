...
mostCurrent._activity.LoadLayout("dashboard",mostCurrent.activityBA);
 //BA.debugLineNum = 28;BA.debugLine="job2.Initialize(\"Job2\", Me)";
mostCurrent._job2._initialize(processBA,"Job2",dashboard.getObject());
 //BA.debugLineNum = 29;BA.debugLine="job2.PostString(domain&\"ta_v2/endpoint/countAll.p";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 75;BA.debugLine="StartActivity(\"birth\")";
...
mostCurrent._job2 = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 17;BA.debugLine="domain=\"http://eb52df92.ngrok.io/\"";
...
String _building = "";
 ...
 //BA.debugLineNum = 44;BA.debugLine="Log(\"JobName = \" & Job.JobName & \", Success = \" &";
...
_root = _parser.NextObject();
 //BA.debugLineNum = 52;BA.debugLine="Dim features As List = root.Get(\"features\")";
_features = new anywheresoftware.b4a.objects.collections.List();
_features.setObject((java.util.List)(_root.Get((Object)("features"))));
 //BA.debugLineNum = 53;BA.debugLine="For Each colfeatures As Map In features";
...
_colfeatures.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group10.Get(index10)));
 //BA.debugLineNum = 54;BA.debugLine="Dim properties As Map = colfeatures.Get(\"prop";
...
_properties.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_colfeatures.Get((Object)("properties"))));
 //BA.debugLineNum = 55;BA.debugLine="Dim citizen As String = properties.Get(\"citiz";
_citizen = BA.ObjectToString(_properties.Get((Object)("citizen")));
 //BA.debugLineNum = 56;BA.debugLine="Dim land As String = properties.Get(\"land\")";
_land = BA.ObjectToString(_properties.Get((Object)("land")));
 //BA.debugLineNum = 57;BA.debugLine="Dim building As String = properties.Get(\"buil";
_building = BA.ObjectToString(_properties.Get((Object)("building")));
 //BA.debugLineNum = 58;BA.debugLine="Log(building)";
anywheresoftware.b4a.keywords.Common.Log(_building);
 //BA.debugLineNum = 59;BA.debugLine="Label10.Text=land";
mostCurrent._label10.setText(BA.ObjectToCharSequence(_land));
 //BA.debugLineNum = 60;BA.debugLine="Label11.Text=building";
mostCurrent._label11.setText(BA.ObjectToCharSequence(_building));
 //BA.debugLineNum = 61;BA.debugLine="Label12.Text=citizen";
...
anywheresoftware.b4a.keywords.Common.Log("Error: "+_job._errormessage);
 //BA.debugLineNum = 68;BA.debugLine="ToastMessageShow(\"Error: \" & Job.ErrorMessage, T";
